...
const AdminModal = ({ title, onClose, onSubmit, submitting, children, size = "md", icon: Icon }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className={`relative bg-white rounded-2xl shadow-2xl w-full ${maxW} max-h-[90vh] overflow-hidden animate-slideUp`}>
        {/* Gradient Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b bg-gradient-to-r from-primary to-deepblue rounded-t-2xl">
